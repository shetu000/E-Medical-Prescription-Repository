...
function matchpassword()
{
	...
	if(password===rpassword)
		...
		{
		document.getElementById('rpasserrormessage').style.visibility = 'visible';
	       document.getElementById('rpasserrormessage').innerText = "Password did not match";
	       document.getElementById("rpassword").style.background = 'Red';
	       document.getElementById("rpassword").value="";
		}

}
function rclearpassword()
{
	document.getElementById("rpassword").style.background = 'White';
	document.getElementById('rpasserrormessage').style.visibility = 'hidden';
...
{
	var adhexp = /^\d{16}$/;
	var adhno = document.getElementById("adhaar").value;
	 
	   var adhflag = false;
	    
	   if(adhexp.test(adhno))
	   {
		   adhflag = true;
	   }
	   else
	   {
		   document.getElementById('adhnoerrormessage').style.visibility = 'visible';
	       document.getElementById('adhnoerrormessage').innerText = "Enter 16 digit UID no.";
	       document.getElementById("adhaar").style.background = 'Red';
	       document.getElementById("adhaar").value="";
	   }
}
function clearadhaar()
{
	document.getElementById("adhaar").style.background = 'White';
	document.getElementById('adhnoerrormessage').style.visibility = 'hidden';
...
function gcheckmobno()
{	
   var gmobnoexp = /^[789]\d{9}$/;


   var gmobno = document.getElementById("gmobno").value;
 
   var gmobnoflag = false;
    
   if(gmobnoexp.test(gmobno))
   {
	   gmobnoflag = true;
   }
   else
   {
	   document.getElementById('gmobnoerrormessage').style.visibility = 'visible';
       document.getElementById('gmobnoerrormessage').innerText = "Enter Valid Mobile No";
       document.getElementById("gmobno").style.background = 'Red';
       document.getElementById("gmobno").value="";
   }
}

function gclearmobno()
{
	document.getElementById("gmobno").style.background = 'White';
	document.getElementById('gmobnoerrormessage').style.visibility = 'hidden';
