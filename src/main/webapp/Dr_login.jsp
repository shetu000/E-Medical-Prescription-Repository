       ...
       <div class="card">
          <div class="card-body" style="background-color: #eeefff">
            ...
            <div class="mt-2 text-center">
               <h3 style="color: darkblue;">DOCTOR LOGIN </h3>
            </div>
            ...
            <div class="mt-4 text-left">
              ...
              <form action="doclogin" method="post">
                ...
                <div class="form-group">
                   <label for="regid" class="text-uppercase font-weight-bold text-primary" >Registration id</label>
                   <input type="text" name="regno" id="regno" class="form-control" placeholder="Enter Your registration no." required >
                </div>
